            ...
            return this.memos = {},
                ...
                this.initializeModule = function(a) {
                    ...
                    d.shouldInitialize = d.shouldInitialize || c.ok,
                        d.shouldInitialize() && (d.initialize && d.initialize(), d.events && p.attachEvents(b, d.events))
                },
                ...
                this.removeModule = function(a) {
                    ...
                    c.shouldInitialize() && (c.events && p.detachEvents(b, c.events), c.destroy && c.destroy()),
                ...
                this.createInvokeHandler = function(b, c) {
                    return function(d) {
                        d.preventDefault(),
                            f.invoke(b, c || a(d.target).closest("[data-value]").data("value"))
                    }
                },
    ...
    a.fn.extend({
        summernote: function() {
            ...
            f = a.extend({}, a.summernote.options, f),
                f.langInfo = a.extend(!0, {}, a.summernote.lang["en-US"], a.summernote.lang[f.lang]),
        ...
        M = function() {
            var b = function(a, b) {
                    ...
                    if (0 !== c && p.isText(h[c - 1])) {
                        ...
                        j.nodeValue;
                        b && j.nextSibling && p.isText(j.nextSibling) && l === j.nodeValue.length && (l -= j.nodeValue.length, j = j.nextSibling),
                            f = j,
                            c = l
                    }
                    return {
                ...
                f = function(b, g, h, i) {
                    ...
                    this.getPoints = function() {
                        ...
                        this.nodes = function(a, b) {
                            ...
                            return p.walkPoint(g, h, function(b) {
                                    if (!p.isEditable(b.node)) {
                                        var c;
                                        f ? (p.isLeftEdgePoint(b) && j.push(b.node), p.isRightEdgePoint(b) && d.contains(j, b.node) && (c = b.node)) : c = e ? p.ancestor(b.node, a) : b.node,
                                            c && a(c) && i.push(c)
                                    }
                                }, !0),
                                d.unique(i)
                        ...
                        this.splitText = function() {
                            var a = b === h,
                                c = this.getPoints();
                            return p.isText(h) && !p.isEdgePoint(this.getEndPoint()) && h.splitText(i),
                                p.isText(b) && !p.isEdgePoint(this.getStartPoint()) && (c.sc = b.splitText(g), c.so = 0, a && (c.ec = c.sc, c.eo = i - g)),
                    ...
                    this.isOnEditable = k(p.isEditable),
                        ...
                        this.wrapBodyInlineWithPara = function() {
                            ...
                            if (p.isInline(a.sc)) {
                                ...
                                e = d.last(g),
                                    p.isInline(e) || (e = g[g.length - 2] || a.sc.childNodes[a.so])
                            } else
            ...
            return {
                ...
                createFromSelection: function() {
                    ...
                    if (m.isW3CRangeSupport) {
                        ...
                        var l = b(k, !0),
                            n = b(j, !1);
                        p.isText(l.node) && p.isLeftEdgePoint(l) && p.isTextNode(n.node) && p.isRightEdgePoint(n) && n.node.nextSibling === l.node && (l = n),
                            a = l.cont,
                            c = l.offset,
                            d = n.cont,
                            e = n.offset
                ...
                createFromNode: function(a) {
                    var b = a,
                        ...
                        d = a,
                        e = p.nodeLength(d);
                    return p.isVoid(b) && (c = p.listPrev(b).length - 1, b = b.parentNode),
                        p.isBR(d) ? (e = p.listPrev(d).length - 1, d = d.parentNode) : p.isVoid(d) && (e = p.listPrev(d).length, d = d.parentNode),
                        this.create(b, c, d, e)
                },
        ...
        P = function() {
            ...
            this.fromNode = function(a) {
                    ...
                    if (g) {
                        ...
                        return j.map(function(b) {
                            ...
                            return a.each(f, function(a, b) {
                                    p.appendChildNodes(e, b.childNodes),
                                        p.remove(b)
                                }),
                                d.head(c)
                        })
                ...
                this.current = function(b) {
                    ...
                    return d.anchor = b.isOnAnchor() && p.ancestor(b.sc, p.isAnchor),
            ...
            this.insertOrderedList = function(a) {
                ...
                this.releaseList = function(b, c) {
                    ...
                    return a.each(b, function(b, f) {
                            ...
                            f = c ? p.listDescendant(k, p.isLi) : d.from(k.childNodes).filter(p.isLi),
                                (c || !p.isList(i.parentNode)) && (f = f.map(function(a) {
        ...
        U = function(b) {
            ...
            this.initialize = function() {
                    ...
                    g.on(a, function() {
                        ...
                        }), !h.airMode && h.height && this.setHeight(h.height), !h.airMode && h.maxHeight && g.css("max-height", h.maxHeight), !h.airMode && h.minHeight && g.css("min-height", h.minHeight),
                        r.recordUndo()
                },
                this.destroy = function() {
                    g.off()
            ...
            this.tab = function() {
                ...
                this.insertNode = this.wrapCommand(function(a) {
                    ...
                    b.insertNode(a),
                        M.createFromNodeAfter(a).select()
                }),
                ...
                this.getSelectedText = function() {
                    var a = this.createRange();
                    return a.isOnAnchor() && (a = M.createFromNode(p.ancestor(a.sc, p.isAnchor))),
                        a.toString()
                },
        ...
        $ = function(b) {
            ...
            this.toggle = function() {
                    ...
                    c.toggleClass("fullscreen"),
                        this.isFullscreen() ? (e.data("orgHeight", e.css("height")), g.on("resize", function() {
                            a({
        ...
        da = function(b) {
            var e = this,
                ...
                k = this.representShortcut = function(a) {
                    var b = j[a];
                    return m.isMac && (b = b.replace("CMD", "⌘").replace("SHIFT", "⇧")),
            ...
            this.initialize = function() {
                ...
                this.isFontInstalled = function(a) {
                    return e.fontInstalledMap.hasOwnProperty(a) || (e.fontInstalledMap[a] = m.isFontInstalled(a) || d.contains(h.fontNamesIgnoreCheck, a)),
        ...
        fa = function(b) {
            ...
            this.initialize = function() {
                    var b = f.dialogsInBody ? a(document.body) : e,
                        ...
                        g.link.url + '</label><input class="note-link-url form-control" type="text" value="http://" /></div>' +
                        (f.disableLinkTarget ? "" : '<div class="checkbox"></div>'),
        ...
        ma = function(b) {
            ...
            this.events = {
                ...
                this.nodeFromItem = function(a) {
                    ...
                    return "string" == typeof d && (d = p.createText(d)),
                        d
                },
