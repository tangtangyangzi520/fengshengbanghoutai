<template>
 <div style="position: absolute;top:0;left:0;width:100%;height:100%;" v-show="showPage">
       ...
       <div class="box" style="margin-left: 10%;">
           <ul>
               <li v-for="item in firstList"><a @click="secondbuild(item,$event)">{{item.text}}</a><span v-for="i in 6">&nbsp;</span> > </li> 
           </ul>
       </div>  
       <div class="box">
           <ul>
               <li v-for="item in secondList"><a @click="thirdbuild(item,$event)">{{item.text}}</a><span v-for="i in 6">&nbsp;</span> > </li> 
           </ul>
       </div>  
       <div class="box">
           <ul>
               <li v-for="item in thirdList"><a :id="item.id" @click="thirdSelect(item,$event)">{{item.text}}</a><span v-for="i in 6">&nbsp;</span> > </li> 
           </ul>
       </div> <br><br>  
