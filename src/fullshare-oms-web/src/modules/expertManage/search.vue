<template>
    <form class="row search-form" style="margin: 5px 0 0 0">
            ...
            <input type="hidden" class="form-control"  v-model="searchOptions.zt">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label class="col-md-3">经营类目：</label>
                    <div class="col-md-9">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <!-- <m-multi-select :data="painList" :active-items="painIdsActive" :placeholder="'请选择二级类目'" :change-func="selectPainFunc"></m-multi-select> -->
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                ...
                <label class="col-md-3"></label>
                    <div class="col-md-9">
                        ...
                        <!-- <m-multi-select :data="chanelList" :active-items="channelIdActive" :placeholder="'请选择三级类目'" :change-func="selectChanelFunc"></m-multi-select> -->
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        // 获取类目列表
        getLEIMUList() {
            client.postData("http://tapi.fshtop.com/cms-manager/tag/getTagTree?typeId=100", {}).then(data => {
                if (data.code == 200) {
