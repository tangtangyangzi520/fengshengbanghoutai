<template>
    <div>
        ...
        <m-alert :title="'提交内容'" :show-cancel-btn="true" :show="showSubmitDialog" :onsure="ajaxControl" :onhide="hideMsg">
            <div slot="content">确定让该限时折扣失效吗？</div>
        </m-alert>
        <!--确定发布-->
        ...
        <m-alert :title="'删除内容'" :show-cancel-btn="true" :show="showDeleteDialog" :onsure="ajaxControl" :onhide="hideMsg">
            <div slot="content">确定删除该限时折扣吗？</div>
        </m-alert>
        ...
        show(val) {
            ...
            switch (this.type) {
                case 'submit':
                    ...
                    this.tips = '该限时折扣已失效';
                    this.url = MKT_INVALIDATE + "?mkcCampaignId=" + this.items[0];
                    break;
                case 'reject':
                    this.rejectDesc = '';
                ...
                case 'delete':
                    this.tips = '删除成功';
                    this.url = MKT_DELETE + "?mkcCampaignId=" + this.items[0];
