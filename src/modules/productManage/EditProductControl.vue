            ...
            <div slot="content">
                ...
                <div class="row" style="background-color:#F0F0F0">
                    <form class="form-horizontal" name="addForm" role="form">
                        ...
                        <div class="form-group">
                            <label for="title" class="col-sm-3 control-label">商品广告词：</label>
                        ...
                        <div class="form-group">
                            <label for="title" class="col-sm-3 control-label">商品关键词：</label>
                            <div class="controls col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls col-md-8">
                                <textarea  v-model="request.spuExpertOption" placeholder="100个字以内" maxLength="100" cols="50" rows="3">
                                </textarea> 
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls col-md-5">
                                ...
                                <div class="col-sm-5" >
                                    <input type="number" class="form-control input-sm" v-model="request.spuFreight" placeholder="0.00" max="999"  min="0" @keyup="check($event)" @change="check($event)"/>
                                </div>
                                <br><br><br>
                                <div class="col-md-4" >
                                    <input type="radio" name="yunfei" v-model="yunfei" value="1">运费模板
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="controls col-md-4" id="selects" >
                                ...
                                <div style="background-color:white;border: 1px solid black;width:340px"><br>
                                    <span v-for="(index,i) in createinsurancelist">&nbsp;&nbsp;&nbsp;&nbsp;类型
                                        <input type="text" style="display:inline-block" v-model="i.keyValue" @keyup="checkinsurance(i,1)" maxLength="50"/> <br>
                                        &nbsp;&nbsp;&nbsp;&nbsp;描述
