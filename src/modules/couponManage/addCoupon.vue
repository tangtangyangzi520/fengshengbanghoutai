                ...
                <div class="row" style="background-color:#F0F0F0">
                    <form class="form-horizontal" name="addForm" role="form" id='submitform'>
                        ...
                        <div class="form-group" style="margin-top:-0.2%">
                            ...
                            &nbsp;&nbsp;
                            <p style="margin-left:-1.7%;margin-top:-0.4%">
                                <span style="color:#999999">10个字以内</span>
                            </p>
                        </div>
                        <div class="form-group">
                            ...
                            <label class="col-sm-0 control-label" style="margin-left:-0.5%;margin-top:0.4%">张</label>
                        </div>
                        <div class="form-group" >
                            <label for="title" class="col-sm-3 control-label">
                            ...
                            <div class="col-md-8 nopadding">
                                ...
                                <label  class="col-sm-0 control-label" style="margin-left:-0.8%;margin-top:-0.1%">元</label>
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-md-8 nopadding">
                                ...
                                <div class="col-md-3" style="margin-left:-10%;margin-top:0.4%">  
                                    <input type="number" class="form-control input-sm" v-model="request.mkcUsedCondition" placeholder="" max="999999" required="required" min="0" step="0.01" 
                                        @keyup="checkFloat($event)" @change="checkFloat($event)" :class="{ 'active': isActive }"/>
                                </div>
                                <label  class="col-sm-0 control-label" style="margin-left:-0.6%;margin-top:0.5%">元可使用</label>
                                <div style="color:#FF6633;margin-left:2%;margin-top:1.2%">使用门槛计算不包含运费</div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-8 nopadding">
                                ...
                                <div class="col-sm-8" >
                                    ...
                                    <input id="today" type="number" min="0" max="99" v-model="request.mkcDateNum" v-show="!todayHtml"
                                        @keyup="integer($event)" @change="integer($event)" @blur="integer($event)" style="display:none" class="active"/> 
                                        天内有效<br><br>
                                    ...
                                    <input v-show="!nextDayHtml" type="number" min="0" max="99" v-model="request.mkcDateNum" @keyup="integer($event)" 
                                        @change="integer($event)" @blur="integer($event)" style="display:none" class="active" /> 
                                        天内有效
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group" v-for="spu in spuList">
                            <table class="tab" id="t" style="width:850px;margin-left:16%" border="1" cellspacing="0" cellpadding="0">  
                                <thead>
                                    <tr>
                                        <th style="width:10%">
                        ...
                        <div class="form-group">
                            <label for="title" class="col-sm-3 control-label">使用说明：</label>
                            <div class="controls col-md-6" style="margin-top:1%">
                                <textarea v-model="request.mkcRemark" placeholder="填写活动的详细说明，支持换行,最多200字" maxLength="200" rows="7" cols="60"></textarea> 
                            </div>
                        </div>
                    </form>
                </div>
